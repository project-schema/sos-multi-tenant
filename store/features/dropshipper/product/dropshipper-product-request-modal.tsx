...
import { z } from 'zod';
import { useRequestProductMutation } from './dropshipper-product-api-slice';
...
//  Component
export function DropshipperProductRequestModal({
	tenantId,
	productId,
}: {
	tenantId: string;
	...
	return (
		<Dialog open={open} onOpenChange={setOpen}>
			...
			<DialogContent className={cn('sm:max-w-xl w-full')}>
				...
				<FORM setOpen={setOpen} tenantId={tenantId} productId={productId} />
			</DialogContent>
		</Dialog>
	);
}
