...
} from './vendor-withdraw-api-slice';
...
export function TenantWithdrawModal() {
...
const FORM = ({
	...
	const { data: allBanks, isLoading: isLoadingBanks } =
		useTenantAllBanksQuery(undefined);
	const [mutate, { isLoading }] = useTenantWithdrawMoneyMutation();
