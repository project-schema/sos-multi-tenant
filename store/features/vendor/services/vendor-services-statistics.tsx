	...
	return (
		<div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6 gap-4 pb-4">
			<Card1
				...
				countTitle={stats.totalservice?.toString() || '00'}
				icon={TrendingUp}
			...
			<Card1
				title="Pending Ads"
				countTitle={stats.totalpendingservice?.toString() || '00'}
				icon={Clock}
			...
			<Card1
				title="In Progress"
				countTitle={stats.totalprogressadvertise?.toString() || '00'}
				icon={Clock}
			...
			<Card1
				title="Delivered"
				countTitle={stats.totaldeliveredadvertise?.toString() || '00'}
				icon={PackageCheck}
			...
			<Card1
				title="Cancelled"
				countTitle={stats.totalcanceldadvertise?.toString() || '00'}
				icon={PackageX}
