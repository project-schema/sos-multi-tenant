...
import { useVendorWarehouseReportQuery } from './vendor-report-api-slice';
import { VendorReportFilter } from './vendor-report-filter';

export function VendorWarehouseReportPage() {
					...
					<>
						<div className="border rounded-lg relative">
							...
							<Table>
								...
								<TableBody>
									{data.warehouse_report.data.length === 0 ? (
										<TableRow>
											<TableCell
												colSpan={5}
										...
										data.warehouse_report.data?.map((item, i) => {
											...
											return (
												<TableRow key={item.id}>
													...
													<TableCell className="py-2">
														{textCount(item.warehouse_name, 30)}
													</TableCell>
													<TableCell className="py-2">
						...
						<Pagination1
							pagination={data?.warehouse_report}
							setPage={setPage}
						/>
					</>
				)}
