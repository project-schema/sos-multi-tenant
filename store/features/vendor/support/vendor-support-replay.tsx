...
import { z } from 'zod';
import { useVendorSupportReplayMutation } from './vendor-support-api-slice';
import { iVendorSupport } from './vendor-support-type';
...
export function VendorSupportReplay({ data }: { data: iVendorSupport }) {
