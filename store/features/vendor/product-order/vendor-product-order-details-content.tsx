...
export function VendorProductOrderDetailsContent({
	order,
}: {
	...
	return (
		<div className="space-y-4">
			<div className="rounded-lg border bg-background px-6 py-5">
			...
			<div className="grid grid-cols-1 gap-4 lg:grid-cols-3">
				...
				<InfoCard title="Shipping Address">
					...
					<InfoRow
						label="Shipping date"
						value={order.shipping_date ? dateFormat(order.shipping_date) : null}
					/>
				</InfoCard>
				...
				<InfoCard title="Payment & Delivery">
					...
					/>
					<InfoRow label="Discount" value={formatAmount(order.sale_discount)} />
			...
			<Card className="shadow-none">
				<CardHeader className="border-b pb-3">
					<CardTitle className="text-sm font-semibold">Items ordered</CardTitle>
				</CardHeader>
						...
						<Table>
							<TableHeader>
								<TableRow className="bg-muted/40 hover:bg-muted/40">
									...
									<TableHead className="text-xs uppercase">Variant</TableHead>
