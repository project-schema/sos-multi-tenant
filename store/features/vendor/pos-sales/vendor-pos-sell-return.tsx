...
import { useVendorPosSellReturnMutation } from './vendor-pos-sales.api-slice';
...
export function VendorPOSalesSellReturn({
	data,
}: {
			...
			<Card>
				<CardHeader>
					<CardTitle className="flex items-center justify-between">
						...
						<Badge variant="outline">{showData.sale_date}</Badge>
					</CardTitle>
				</CardHeader>
				<CardContent>
					<div className="grid grid-cols-1 md:grid-cols-2 gap-6">
						...
						<div>
							...
							<div className="space-y-1 text-sm">
								<p className="font-medium">{logo?.shop_name || 'Shop Name'}</p>
