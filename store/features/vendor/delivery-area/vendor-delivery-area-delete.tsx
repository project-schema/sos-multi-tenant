...
import { useVendorPickAndDeliveryAddressDeleteMutation } from './vendor-delivery-area-api-slice';
import { iVendorPickAndDeliveryAddress } from './vendor-delivery-area-type';

export function VendorPickAndDeliveryAddressDelete({
	data,
}: {
	data: iVendorPickAndDeliveryAddress;
}) {
