...
import { useVendorServicesPurchaseCountQuery } from './api-slice';

export function VendorServicesPurchaseOrderStatistics() {
	const { data, isLoading, isError } =
		useVendorServicesPurchaseCountQuery(undefined);
