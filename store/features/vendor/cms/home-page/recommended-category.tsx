...
const schema = z.object({
	...
	recomended_sub_category_id_2: z.string().optional(),
	recomended_category_id_3: z.string().optional(),
	recomended_sub_category_id_3: z.string().optional(),
	recomended_category_id_4: z.string().optional(),
	recomended_sub_category_id_4: z.string().optional(),
});
...
export function RecommendedCategory() {
	...
	const form = useForm<ZodType>({
		...
		defaultValues: {
			...
			recomended_category_id_2: data?.data?.recomended_category_id_2 || '',
			recomended_sub_category_id_2:
				data?.data?.recomended_sub_category_id_2 || '',
			recomended_category_id_3: data?.data?.recomended_category_id_3 || '',
			recomended_sub_category_id_3:
				data?.data?.recomended_sub_category_id_3 || '',
			recomended_category_id_4: data?.data?.recomended_category_id_4 || '',
			recomended_sub_category_id_4:
				data?.data?.recomended_sub_category_id_4 || '',
		},
	});

	// Watch category selections for dynamic subcategory filtering
	const categoryId1 = form.watch('recomended_category_id_1');
	const categoryId2 = form.watch('recomended_category_id_2');
	const categoryId3 = form.watch('recomended_category_id_3');
	const categoryId4 = form.watch('recomended_category_id_4');

	const subcategoryId1 = form.watch('recomended_sub_category_id_1');
	const subcategoryId2 = form.watch('recomended_sub_category_id_2');
	const subcategoryId3 = form.watch('recomended_sub_category_id_3');
	const subcategoryId4 = form.watch('recomended_sub_category_id_4');
				...
				<Form {...form}>
					<form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
						...
						<div className="grid grid-cols-2 gap-4">
							...
							<FormField
								control={form.control}
								name="recomended_sub_category_id_1"
								render={({ field }) => (
									<SearchableSelect
										field={field}
										label="Subcategory 1"
						...
						<div className="grid grid-cols-2 gap-4">
							...
							<FormField
								control={form.control}
								name="recomended_sub_category_id_2"
								render={({ field }) => (
									<SearchableSelect
										field={field}
										label="Subcategory 2"
						...
						<div className="grid grid-cols-2 gap-4">
							...
							<FormField
								control={form.control}
								name="recomended_sub_category_id_3"
								render={({ field }) => (
									<SearchableSelect
										field={field}
										label="Subcategory 3"
						...
						<DialogFooter>
							<Button type="submit" disabled={isLoading}>
								...
								{isLoading ? 'Update...' : 'Update Recommended Category'}
							</Button>
						</DialogFooter>
					</form>
				</Form>
