...
const schema = z.object({
	extra_section_tittle_4: z.string().min(1, 'Title is required'),
...
export function ProductSection4() {
	...
	const form = useForm<ZodType>({
		...
		defaultValues: {
			extra_section_tittle_4: data?.data?.extra_section_tittle_4 || '',
	...
	const categoryId = form.watch('recomended_category_id_1');
	const subcategoryId = form.watch('recomended_sub_category_id_1');
	...
	useEffect(() => {
		...
		if (categoryId && subcategoryId) {
			...
			if (!isValid) {
				form.setValue('recomended_category_id_1', '');
			}
