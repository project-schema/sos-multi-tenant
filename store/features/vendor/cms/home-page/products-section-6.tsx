...
export function ProductSection6() {
	...
	const form = useForm<ZodType>({
		...
		defaultValues: {
			best_section_title: data?.data?.extra_section_tittle_6 || '',
			best_category_id: data?.data?.recomended_category_id_3 || '',
			best_sub_category_id: data?.data?.recomended_sub_category_id_3 || '',
		},
	});
			...
			onOk: async () => {
				try {
					const response = await store({
						extra_section_tittle_6: data.best_section_title,
						recomended_category_id_3: data.best_category_id,
						recomended_sub_category_id_3: data.best_sub_category_id,
					}).unwrap();
