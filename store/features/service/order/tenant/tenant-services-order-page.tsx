...
import { iAdminServiceOrder } from '@/store/features/admin/service';
import { ServiceOrderStatus } from '@/store/features/vendor/services-purchase/service-order-status';
import { useVendorServicesOrderQuery } from '@/store/features/vendor/services/vendor-services-api-slice';
import { useEffect, useState } from 'react';
import { ServiceOrderCancelReq } from './service-order-cancel-req';
import { VendorServicesOrderStatistics } from './vendor-services-order-statistics';
export function TenantServicesOrderPage() {
							...
							<Table>
								...
								<TableBody>
									{services?.data.length === 0 ? (
										...
										services?.data.map((item: iAdminServiceOrder, i: number) => {
											return (
