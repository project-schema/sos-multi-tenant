...
import { z } from 'zod';
import { iVendorServices } from '../../../vendor/services/vendor-services-type';
import {
	useVendorServiceCategoryAndSubCategoryQuery,
	useVendorServicesUpdateMutation,
} from './tenant-services-api-slice';
...
export function TenantServicesEditPage({
	editData,
}: {
