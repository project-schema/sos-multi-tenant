...
import { iTenantServicesResponse } from './tenant.service.type';
...
const api = apiSlice.injectEndpoints({
	endpoints: (builder) => ({
		...
		// view
		VendorServicesView: builder.query<iService, { id: string }>({
			query: ({ id }) => `/tenant-service/${id}`,
			providesTags: ['VendorService'],
		}),

		VendorServiceCategoryAndSubCategory: builder.query<any, void>({
