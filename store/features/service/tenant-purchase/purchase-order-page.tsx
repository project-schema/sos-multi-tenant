...
import { TenantServicePurchaseOrderStatistics } from './purchase-order-statistics';
export function TenantServicesPurchaseOrderPage() {
			...
			<Container1
				...
				header={
					<>
						...
						{toggleFilter && <TenantServicePurchaseOrderStatistics />}
					</>
				}
			>
				{/* Filter */}
													...
													<TableCell className="py-2">
														{item?.servicedetails ? (
															<Link
																...
																href={`/dashboard/expertise/purchase-order/${item.id}/view`}
															>
