...
import { useAdminDeleteProductMutation } from './service-order.api.slice';
import { iDropShipReq } from './service-order.type';

export function AdminServiceOrderDelete({ data }: { data: iDropShipReq }) {
