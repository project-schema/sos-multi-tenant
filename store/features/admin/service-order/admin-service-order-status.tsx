...
import { useAdminServiceOrderStatusUpdateMutation } from './service-order.api.slice';
import { iAdminServiceOrder } from './service-order.type';

export function AdminServiceOrderStatus({
	data,
	status,
	text,
	icon,
	...
	const [mutation, { isLoading }] = useAdminServiceOrderStatusUpdateMutation();
