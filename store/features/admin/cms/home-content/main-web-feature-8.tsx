...
const schema = z.object({
	f_feature_image_8: z.instanceof(File).optional(),
	progres_three_title: z.string().optional(),
	progres_four_title: z.string().optional(),

	chose_us_title: z.string().optional(),
	chose_us_heading: z.string().optional(),
});

type ZodType = z.infer<typeof schema>;

export function MainWebFeature8() {
	...
	const form = useForm<ZodType>({
		...
		defaultValues: {
			f_feature_image_8: undefined,
			progres_three_title: setting?.progres_three_title ?? '',
			progres_four_title: setting?.progres_four_title ?? '',

			chose_us_title: setting?.chose_us_title ?? '',
			chose_us_heading: setting?.chose_us_heading ?? '',
		},
	});
										...
										<FormControl>
											<ImageUpload
												...
												defaultImage={imageFormat(
													setting?.f_feature_image_8 ?? null,
												)}
											/>
										</FormControl>
										<FormMessage />
