...
const schema = z.object({
	partner_heading: z.string().optional(),
	partner_title: z.string().optional(),
});

type ZodType = z.infer<typeof schema>;

export function MainWebFeature9() {
	...
	const form = useForm<ZodType>({
		...
		defaultValues: {
			partner_heading: setting?.partner_heading ?? '',
			partner_title: setting?.partner_title ?? '',
		},
	});
