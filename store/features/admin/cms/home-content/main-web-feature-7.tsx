...
const schema = z.object({
	progres_two_title: z.string().optional(),
	progress_title: z.string().optional(),
});

type ZodType = z.infer<typeof schema>;

export function MainWebFeature7() {
	...
	const form = useForm<ZodType>({
		...
		defaultValues: {
			progres_two_title: setting?.progres_two_title ?? '',
			progress_title: setting?.progress_title ?? '',
		},
	});
