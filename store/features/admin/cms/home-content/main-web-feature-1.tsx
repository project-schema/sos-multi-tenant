...
const schema = z.object({
	service_one_heading: z.string().optional(),
	service_one_title: z.string().optional(),
});

type ZodType = z.infer<typeof schema>;

export function MainWebFeature1() {
	...
	const form = useForm<ZodType>({
		...
		defaultValues: {
			service_one_title: setting?.service_one_title ?? '',
			service_one_heading: setting?.service_one_heading ?? '',
		},
	});
