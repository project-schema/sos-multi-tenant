...
import { useAdminDeleteProductMutation } from './product-order.api.slice';
import { iDropShipReq } from './product-order.type';

export function MerchantProductDelete({ data }: { data: iDropShipReq }) {
