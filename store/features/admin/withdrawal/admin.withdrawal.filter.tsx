...
export function AdminWithdrawalFilter({
	filters,
	setFilters,
	clearFilters,
}: {
	...
	return (
		<div className="grid grid-cols-2 lg:grid-cols-4 2xl:grid-cols-8 gap-4">
			...
			<Select
				...
				onValueChange={(value: 'all' | 'success' | 'pending') =>
			...
			<Select
				value={filters.type}
				onValueChange={(value: 'all' | 'vendor' | 'affiliator' | 'user') =>
			...
			>
				...
				<SelectContent>
					...
					<SelectItem value="affiliator">Dropshipper</SelectItem>
