...
import { useAdminSupportReplayMutation } from './admin.support.api.slice';
import { iAdminSupportView } from './admin.support.type';

export function AdminSupportReplay({ data }: { data: iAdminSupportView }) {
