...
import { useAdminStoreSubCategoryMutation } from './sub-category.api.slice';
...
export function SubCategoryCreate() {
	...
	const [store, { isLoading }] = useAdminStoreSubCategoryMutation();
