...
import { useAdminViewCrmCompanionQuery } from './crm-admin-companion.api.slice';
import { CrmCompanionDelete } from './crm-admin-companion.delete';
import { CrmCompanionEdit } from './crm-admin-companion.edit';
