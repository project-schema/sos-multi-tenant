...
import {} from './crm-admin-organization-two.type';
...
import { useAdminStoreCrmOrganizationTwoMutation } from './crm-admin-organization-two.api.slice';
...
export function CrmOrganizationTwoCreate() {
	const [store, { isLoading }] = useAdminStoreCrmOrganizationTwoMutation();
