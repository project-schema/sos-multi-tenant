...
import { useAdminViewCrmOrganizationTwoQuery } from './crm-admin-organization-two.api.slice';
import { CrmOrganizationTwoDelete } from './crm-admin-organization-two.delete';
import { CrmOrganizationTwoEdit } from './crm-admin-organization-two.edit';

export function CrmOrganizationTwoTable() {
	const { data, isFetching, isLoading, isError } = useAdminViewCrmOrganizationTwoQuery({
		page: '',
	});
