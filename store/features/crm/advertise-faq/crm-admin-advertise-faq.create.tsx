...
import {} from './crm-admin-advertise-faq.type';
...
import { useAdminStoreCrmAdvertiseFaqMutation } from './crm-admin-advertise-faq.api.slice';
	...
	const onSubmit = async (data: ZodType) => {
		try {
			...
			if (response.status === 200) {
				toast.success(response.message || 'AdvertiseFaq Created successfully');
				form.reset();
			} else {
