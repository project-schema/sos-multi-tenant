...
import { useAdminUpdateCrmAdvertiseFaqMutation } from './crm-admin-advertise-faq.api.slice';
import { iCrmAdvertiseFaq } from './crm-admin-advertise-faq.type';
	...
	const onSubmit = async (data: ZodType) => {
		try {
			...
			if (response.status === 200) {
				toast.success(response.message || 'AdvertiseFaq updated successfully');
				setOpen(false);
			} else {
