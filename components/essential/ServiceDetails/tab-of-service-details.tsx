							...
							<div className={style.tabContentBox}>
								...
								<div className={style.tabfullBtnb}>
									<button
										onClick={() =>
											buyPackage({
												vendor_service_id: e?.vendor_service_id,
												service_package_id: e?.id,
												price: e?.price,
											})
										}
...
export const Tab = ({
	...
	return (
		<motion.div
			...
			className={`${style.tabHeaderContent} ${tab === value && style.active}`}
		>
			{text}
		</motion.div>
	);
...
// 				</TabList>
// 				{data?.servicepackages?.map((e: any) => (
// 					<TabPanel key={e?.id} className={style.boxtab}>
// 						<div className={style.tabContentBox}>
