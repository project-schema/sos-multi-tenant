		...
		<section
			...
			style={{
				backgroundImage: imageFormat(
					settings?.message?.f_feature_image_8 ?? null,
				),
			}}
		>
			<div className="container mx-auto">
				<div className="flex flex-col justify-between items-center py-[160px]">
					<MotionFadeIn>
						<h6 className="text-secondary font-semibold md:text-[64px] text-[28px] md:leading-[68px] leading-[32px] mb-[24px] text-center">
							{settings?.message?.chose_us_title}
						</h6>
					</MotionFadeIn>

					<MotionFadeIn direction="down">
						<p className="text-[18px] leading-[26px] md:mb-[34px] mb-[24px] text-secondary text-center">
