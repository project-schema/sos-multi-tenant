			...
			<div className="container mx-auto z-10">
					...
					<div className="pb-[25px] md:pb-[39px] flex flex-col justify-center items-center ">
						...
						>
							<img
								...
								alt="..."
							/>
							১২,০০০+ মানুষের আস্থার প্রতিষ্ঠান
						</span>
               ...
               lg:mb-[30px]"
						...
						{settings.message?.home_banner_description && (
							<p
								className="max-w-2xl md:mb-[50px] mb-[20px]"
								data-aos="fade-up"
						...
						<div
							className=" flex flex-wrap justify-center gap-4 btn--wrap select-none"
							data-aos="fade-up"
