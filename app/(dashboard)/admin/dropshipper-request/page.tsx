...
import {
	...
	DropshipperProductStatistics,
	DropshipperProductTable,
	useAdminRequestProductQuery,
} from '@/store/features/admin/dropshipper-request';
...
export default function Page() {
	...
	const { data, isLoading, isError, isFetching } = useAdminRequestProductQuery({
		status: statusFilter,
		page: page,
			...
			<Container1
				...
				header={
					<>
						...
						{toggleFilter && <DropshipperProductStatistics />}
					</>
				}
			>
				{toggleFilter && (
